...
if(!module.parent){
  ...
  var router = {
    route: function(x){console.log('route',x)}
  }
  
  var em;
  var Director = {
    NewWithEmitter: function(emitter){em = emitter}
  }
  
  var pf = new ProducerForge({Director:Director});
  var pd = pf.NewWithRouter(router,emitter);
